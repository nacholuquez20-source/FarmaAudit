...
**Fase 4 — Bot de campañas**:
estados `CAMPANIA_*` en el dispatcher → digest agregado en vez de mensaje por tarea/campaña, botones reales limitados a Completada/Falta insumo sin declarar "En_ejecucion" **(v2)** → franjas horarias 13:30-16h / después de 20h, máx. 1 recordatorio/día por sucursal **(v2)** → jobs de recordatorio y escalamiento → mitigación de colisión de estados.
